...
const SITE = {
  ...
  phone: '+91 96296 69602',
  phoneDial: '+919629669602',
  phone2: '+91 88704 18345',
  phone3: '+91 96298 69180',
  whatsapp: '919629669602',
  whatsappDisplay: '+91 96296 69602',
  email: 'southernengineers21@gmail.com',
  address: 'Shop No. 37C, RS Colony, Papanasam Main Road, Near Railway Station',
  city: 'Ambasamudram',
  district: '',
  state: 'Tamil Nadu',
  pincode: '627401',
...
const products = [
  ...
  },
  {
    ...
    code: 'INS-01',
    description: 'A bourdon pressure gauge for monitoring line pressure on vessels, pumps and piping systems.',
  ...
  },
  {
    ...
    group: 'Instrumentation',
    code: 'INS-02',
    description: 'A flow-measurement instrument for monitoring water, utility or process flow quantities.',
  ...
  },
  {
    ...
    group: 'Equipment',
    code: 'EQP-01',
    description: 'Pump set package for water transfer, process duty and industrial utility applications.',
  ...
  },
  {
    ...
    group: 'Equipment',
    code: 'EQP-03',
    description: 'A generator set for standby or site power supply and backup electrical requirements.',
